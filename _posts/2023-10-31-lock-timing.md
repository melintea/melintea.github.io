...
- pthread_spinlock_t: 
    ...
    - Custom-written spinlocks could behave better (the pthead one is written in directly in assembler though; so good luck. Fedor Pikus' one has very good performance[^1]).
    - Here is is:
