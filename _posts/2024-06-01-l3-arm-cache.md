...
Summary: 
- keeping the L3 cache line the same as L1/2 is a good idea
- keep the line cache reasonable. Fetching 256 for a line instead of 64 has a time/bandwidth impact; and false sharing gets really annoying.
- do not share L3 between CPUs
